(function (global, factory) {
    ...
    var ar = _moment__default.defineLocale('ar', {
        ...
        preparse: function (string) {
            return string.replace(/\u200f/g, '').replace(/[١٢٣٤٥٦٧٨٩� ]/g, function (match) {
    ...
    function be__monthsCaseReplace(m, format) {
        var months = {
                'nominative': '�?тудзень_люты_�?акавік_кра�?авік_травень_ч�?рвень_ліпень_жнівень_вера�?ень_ка�?трычнік_лі�?тапад_�?нежань'.split('_'),
                'accusative': '�?тудзен�?_лютага_�?акавіка_кра�?авіка_траўн�?_ч�?рвен�?_ліпен�?_жніўн�?_вера�?н�?_ка�?трычніка_лі�?тапада_�?нежн�?'.split('_')
            },
    ...
    function be__weekdaysCaseReplace(m, format) {
        var weekdays = {
                'nominative': 'н�?дзел�?_пан�?дзелак_аўторак_�?ерада_чацвер_п�?тніца_�?убота'.split('_'),
                'accusative': 'н�?дзелю_пан�?дзелак_аўторак_�?ераду_чацвер_п�?тніцу_�?уботу'.split('_')
            },
            nounCase = (/\[ ?[Вв] ?(?:мінулую|на�?тупную)? ?\] ?dddd/).test(format) ?
                'accusative' :
                'nominative';
    ...
    var bn = _moment__default.defineLocale('bn', {
        months : 'জান�?য়ারী_ফেব�?য়ারী_মার�?চ_�?প�?রিল_মে_জ�?ন_জ�?লাই_অগাস�?ট_সেপ�?টেম�?বর_অক�?টোবর_নভেম�?বর_ডিসেম�?বর'.split('_'),
        monthsShort : 'জান�?_ফেব_মার�?চ_�?পর_মে_জ�?ন_জ�?ল_অগ_সেপ�?ট_অক�?টো_নভ_ডিসেম�?'.split('_'),
        weekdays : 'রবিবার_সোমবার_মঙ�?গলবার_ব�?ধবার_বৃহস�?পত�?তিবার_শ�?ক�?র�?বার_শনিবার'.split('_'),
        weekdaysShort : 'রবি_সোম_মঙ�?গল_ব�?ধ_বৃহস�?পত�?তি_শ�?ক�?র�?_শনি'.split('_'),
        weekdaysMin : 'রব_সম_মঙ�?গ_ব�?_ব�?রিহ_শ�?_শনি'.split('_'),
        longDateFormat : {
            LT : 'A h:mm সময়',
            LTS : 'A h:mm:ss সময়',
            L : 'DD/MM/YYYY',
        ...
        meridiemParse: /রাত|শকাল|দ�?প�?র|বিকেল|রাত/,
        isPM: function (input) {
            return /^(দ�?প�?র|বিকেল|রাত)$/.test(input);
        },
    ...
    var cs__months = 'leden_únor_březen_duben_květen_�?erven_�?ervenec_srpen_září_říjen_listopad_prosinec'.split('_'),
        cs__monthsShort = 'led_úno_bře_dub_kvě_�?vn_�?vc_srp_zář_říj_lis_pro'.split('_');
    ...
    var hr = _moment__default.defineLocale('hr', {
        months : 'sije�?anj_velja�?a_ožujak_travanj_svibanj_lipanj_srpanj_kolovoz_rujan_listopad_studeni_prosinac'.split('_'),
    ...
    function ka__monthsCaseReplace(m, format) {
        var months = {
                'nominative': 'ი�?ნვ�?� ი_თებე� ვ�?ლი_მ�?� ტი_�?პ� ილი_მ�?ისი_ივნისი_ივლისი_�?გვისტ�?_სექტემბე� ი_�?ქტ�?მბე� ი_ნ�?ემბე� ი_დეკემბე� ი'.split('_'),
                'accusative': 'ი�?ნვ�?� ს_თებე� ვ�?ლს_მ�?� ტს_�?პ� ილის_მ�?ისს_ივნისს_ივლისს_�?გვისტს_სექტემბე� ს_�?ქტ�?მბე� ს_ნ�?ემბე� ს_დეკემბე� ს'.split('_')
            },
    ...
    function ka__weekdaysCaseReplace(m, format) {
        var weekdays = {
                'nominative': 'კვი� �?_�?� შ�?ბ�?თი_ს�?მშ�?ბ�?თი_�?თხშ�?ბ�?თი_ხუთშ�?ბ�?თი_პ�?� �?სკევი_შ�?ბ�?თი'.split('_'),
                'accusative': 'კვი� �?ს_�?� შ�?ბ�?თს_ს�?მშ�?ბ�?თს_�?თხშ�?ბ�?თს_ხუთშ�?ბ�?თს_პ�?� �?სკევს_შ�?ბ�?თს'.split('_')
            },
            nounCase = (/(წინ�?|შემდეგ)/).test(format) ?
                'accusative' :
                'nominative';
        return weekdays[nounCase][m.day()];
    }
    ...
    var ka = _moment__default.defineLocale('ka', {
        ...
        monthsShort : 'ი�?ნ_თებ_მ�?� _�?პ� _მ�?ი_ივნ_ივლ_�?გვ_სექ_�?ქტ_ნ�?ე_დეკ'.split('_'),
        weekdays : ka__weekdaysCaseReplace,
        weekdaysShort : 'კვი_�?� შ_ს�?მ_�?თხ_ხუთ_პ�?� _შ�?ბ'.split('_'),
        weekdaysMin : 'კვ_�?� _ს�?_�?თ_ხუ_პ�?_შ�?'.split('_'),
        longDateFormat : {
            LT : 'h:mm A',
            LTS : 'h:mm:ss A',
            L : 'DD/MM/YYYY',
    ...
    var km = _moment__default.defineLocale('km', {
        months: 'មករា_កុម្ភៈ_មិនា_ម�?សា_ឧសភា_មិ�?ុនា_កក្កដា_សី� ា_កញ្ញា_�?ុលា_វិច្ឆិកា_ធ្នូ'.split('_'),
        monthsShort: 'មករា_កុម្ភៈ_មិនា_ម�?សា_ឧសភា_មិ�?ុនា_កក្កដា_សី� ា_កញ្ញា_�?ុលា_វិច្ឆិកា_ធ្នូ'.split('_'),
        weekdays: 'អាទិ�?្យ_ច�?ន្ទ_អង្គារ_ពុធ_ព្រ� ស្ប�?ិ�?_សុក្រ_សៅរ�?'.split('_'),
        weekdaysShort: 'អាទិ�?្យ_ច�?ន្ទ_អង្គារ_ពុធ_ព្រ� ស្ប�?ិ�?_សុក្រ_សៅរ�?'.split('_'),
        weekdaysMin: 'អាទិ�?្យ_ច�?ន្ទ_អង្គារ_ពុធ_ព្រ� ស្ប�?ិ�?_សុក្រ_សៅរ�?'.split('_'),
        longDateFormat: {
            LT: 'HH:mm',
            LTS : 'LT:ss',
            L: 'DD/MM/YYYY',
        ...
        calendar: {
            sameDay: '[�?្ងៃនៈ ម៉ោង] LT',
            nextDay: '[ស្អែក ម៉ោង] LT',
            nextWeek: 'dddd [ម៉ោង] LT',
            lastDay: '[ម្សិលមិញ ម៉ោង] LT',
            lastWeek: 'dddd [សប្�?ា� �?មុន] [ម៉ោង] LT',
            sameElse: 'L'
        },
        relativeTime: {
            future: '%sទៀ�?',
    ...
    var ml = _moment__default.defineLocale('ml', {
        ...
        isPM : function (input) {
            return /^(ഉച�?ച കഴിഞ�?ഞ�?|വൈക�?ന�?നേരം|രാത�?രി)$/.test(input);
        },
        meridiem : function (hour, minute, isLower) {
            if (hour < 4) {
                return 'രാത�?രി';
    ...
    var ne = _moment__default.defineLocale('ne', {
        ...
        weekdaysMin : 'आइ._सो._मङ�?_ब�?._बि._श�?._श.'.split('_'),
        longDateFormat : {
            LT : 'Aको h:mm बजे',
            LTS : 'Aको h:mm:ss बजे',
            L : 'DD/MM/YYYY',
        ...
        meridiemParse: /राती|बिहान|दिउ�?सो|बेल�?का|सा�?�?|राती/,
        meridiemHour : function (hour, meridiem) {
            if (hour === 12) {
                hour = 0;
            }
            if (meridiem === 'राती') {
                ...
                return hour >= 10 ? hour : hour + 12;
            } else if (meridiem === 'बेल�?का' || meridiem === 'सा�?�?') {
                return hour + 12;
            }
        },
        meridiem : function (hour, minute, isLower) {
    ...
    function ru__weekdaysCaseReplace(m, format) {
        var weekdays = {
            ...
            nounCase = (/\[ ?[Вв] ?(?:прошлую|�?ледующую|�?ту)? ?\] ?dddd/).test(format) ?
                'accusative' :
                'nominative';
        return weekdays[nounCase][m.day()];
    }
    ...
    var si = _moment__default.defineLocale('si', {
        ...
        longDateFormat : {
            ...
            LL : 'YYYY MMMM D',
            LLL : 'YYYY MMMM D, LT',
            LLLL : 'YYYY MMMM D [ව�?නි] dddd, LTS'
        },
        calendar : {
            sameDay : '[අද] LT[ට]',
            nextDay : '[හෙට] LT[ට]',
    ...
    var ta = _moment__default.defineLocale('ta', {
        months : 'ஜனவரி_பிப�?ரவரி_மார�?ச�?_�?ப�?ரல�?_மே_ஜூன�?_ஜூலை_ஆகஸ�?ட�?_செப�?டெம�?பர�?_அக�?டோபர�?_நவம�?பர�?_டிசம�?பர�?'.split('_'),
        monthsShort : 'ஜனவரி_பிப�?ரவரி_மார�?ச�?_�?ப�?ரல�?_மே_ஜூன�?_ஜூலை_ஆகஸ�?ட�?_செப�?டெம�?பர�?_அக�?டோபர�?_நவம�?பர�?_டிசம�?பர�?'.split('_'),
    ...
    var zh_cn = _moment__default.defineLocale('zh-cn', {
        ...
        week : {
            // GB/T 7408-1994《数�?�元和交�?�� ��?·信�?�交�?�·日期和时间表示法》与ISO 8601:1988等效
            dow : 1, // Monday is the first day of the week.
            doy : 4  // The week that contains Jan 4th is the first week of the year.
        }
    });
